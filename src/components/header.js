        ...
        <div className="h-screen bg-slate-900 text-white pt-52 flex justify-start px-10">
            <div>
                ...
                <div className="w-2/3 flex justify-start m-auto">
                    <div className="px-5 py-3 h-fit rounded-xl bg-blue-500 ml-5 mr-6 font-bold text-black text-lg">
                        <span> Watch Now </span>
                    </div>
                    <div className="px-5 py-3 h-fit rounded-xl bg-zinc-700 font-bold text-white text-lg">
